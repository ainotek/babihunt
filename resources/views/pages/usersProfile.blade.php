                ...
                <div class="row mt-5">
                    <div class="col-sm-12">
                        ...
                        <div class="profile-user-box">
                            <div class="row">
                                <div class="col-sm-6">
                                    <span class="float-left mr-3"><img src="{{asset('assets/images/users/avatar-1.jpg')}}" alt="" class="avatar-xl rounded-circle"></span>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="card-box widget-box-four">
                                    <div id="dashboard-1" class="widget-box-four-chart"><canvas width="94" height="40" style="display: inline-block; width: 94px; height: 40px; vertical-align: top;"></canvas></div>
                                    <div class="float-left">
                                        <h4 class="mt-0 font-16 mb-1 text-overflow" title="Total Revenue">Total Revenue</h4>
                                        <p class="font-secondary text-muted">Jan - Apr 2017</p>
                                        <h3 class="mb-0 mt-4"><span>$</span> <span data-plugin="counterup">1,285,960</span></h3>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div><!-- end col -->
                            ...
                            <div class="col-lg-4">
                                <div class="card-box widget-box-four">
                                    <div id="dashboard-2" class="widget-box-four-chart"><canvas width="94" height="40" style="display: inline-block; width: 94px; height: 40px; vertical-align: top;"></canvas></div>
                                    <div class="float-left">
                                        <h4 class="mt-0 font-16 mb-1 text-overflow" title="Total Unique Visitors">Total Unique Visitors</h4>
                                        <p class="font-secondary text-muted">Jan - Apr 2017</p>
                                        <h3 class="mb-0 mt-4"><span>$</span> <span data-plugin="counterup">1,285,960</span></h3>
                                    </div>
                                    <div class="clearfix"></div>
                            ...
                            <div class="col-lg-4">
                                <div class="card-box widget-box-four">
                                    <div id="dashboard-3" class="widget-box-four-chart"><canvas width="94" height="40" style="display: inline-block; width: 94px; height: 40px; vertical-align: top;"></canvas></div>
                                    <div class="float-left">
                                        <h4 class="mt-0 font-16 mb-1 text-overflow" title="Number of Transactions">Number of Transactions</h4>
                                        <p class="font-secondary text-muted">Jan - Apr 2017</p>
                                        <h3 class="mb-0 mt-4"><span>$</span> <span data-plugin="counterup">1,285,960</span></h3>
                                    </div>
                                    <div class="clearfix"></div>
