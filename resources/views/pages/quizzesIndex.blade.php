            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/airbnb.png')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/apple.png')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                            <div class="company-detail mb-3">
                            ...
                            <div class="text-center mt-4">
                                <h5 class="font-weight-normal text-muted">You have to pay</h5>
                                <h3 class="mb-4"><i class="mdi mdi-arrow-up-bold-circle-outline text-success"></i> 89521 <small>USD</small></h3>
                            </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/google.png')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                            <div class="company-detail mb-3">
                            ...
                            <div class="text-center mt-4">
                                <h5 class="font-weight-normal text-muted">You have to pay</h5>
                                <h3 class="mb-4"><i class="mdi mdi-arrow-up-bold-circle-outline text-success"></i> 23657 <small>USD</small></h3>
                            </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/amazon.png')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                            <div class="company-detail mb-3">
                            ...
                            <div class="text-center mt-4">
                                <h5 class="font-weight-normal text-muted">You have to pay</h5>
                                <h3 class="mb-4"><i class="mdi mdi-arrow-down-bold-circle-outline text-danger"></i> 85412 <small>USD</small></h3>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/facebook.png')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                            <div class="company-detail mb-3">
                            ...
                            <div class="text-center mt-4">
                                <h5 class="font-weight-normal text-muted">You have to pay</h5>
                                <h3 class="mb-4"><i class="mdi mdi-arrow-up-bold-circle-outline text-success"></i> 78512 <small>USD</small></h3>
                            </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/intel.png')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                            <div class="company-detail mb-3">
                            ...
                            <div class="text-center mt-4">
                                <h5 class="font-weight-normal text-muted">You have to pay</h5>
                                <h3 class="mb-4"><i class="mdi mdi-arrow-down-bold-circle-outline text-danger"></i> 36528 <small>USD</small></h3>
                            </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/cisco.jpg')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                            <div class="company-detail mb-3">
                            ...
                            <div class="text-center mt-4">
                                <h5 class="font-weight-normal text-muted">You have to pay</h5>
                                <h3 class="mb-4"><i class="mdi mdi-arrow-up-bold-circle-outline text-success"></i> 1254 <small>USD</small></h3>
                            </div>
                    ...
                    <div class="col-md-6 col-xl-3">
                        <div class="company-card card-box">
                            <div class="float-left mr-3">
                                <img src="{{asset('assets/images/companies/yahoo.png')}}" alt="logo" class="company-logo avatar-md rounded">
                            </div>
                            <div class="company-detail mb-3">
                            ...
                            <div class="text-center mt-4">
                                <h5 class="font-weight-normal text-muted">You have to pay</h5>
                                <h3 class="mb-4"><i class="mdi mdi-arrow-down-bold-circle-outline text-danger"></i> 56850 <small>USD</small></h3>
                            </div>
