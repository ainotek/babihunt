                ...
                <div class="row">
                        ...
                        <div class="card-box widget-box-three">
                            <div class="media">
                                <div class="avatar-lg bg-icon rounded-circle align-self-center">
                                    <img class="avatar-sm" src="{{asset('assets/images/icons/clock.svg')}}" title="clock.svg')}}">
                                </div>
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card-box widget-box-three">
                            <div class="media">
                                <div class="avatar-lg bg-icon rounded-circle align-self-center">
                                    <img class="avatar-sm" src="{{asset('assets/images/icons/advertising.svg')}}" title="advertising.svg')}}">
                                </div>
                                <div class="wigdet-two-content media-body text-right">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card-box widget-box-three">
                            <div class="media">
                                <div class="avatar-lg bg-icon rounded-circle align-self-center">
                                    <img class="avatar-sm" src="{{asset('assets/images/icons/paid.svg')}}" title="paid.svg')}}">
                                </div>
                                <div class="wigdet-two-content media-body text-right">
                ...
                <div class="row">
                    <div class="col-xl-3 col-sm-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="{{asset('assets/images/users/avatar-3.jpg')}}" class="img-fluid rounded-circle avatar-md" alt="user">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="{{asset('assets/images/users/avatar-2.jpg')}}" class="img-fluid rounded-circle avatar-md" alt="user">
                                <div class="wid-u-info">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="{{asset('assets/images/users/avatar-1.jpg')}}" class="img-fluid rounded-circle avatar-md" alt="user">
                                <div class="wid-u-info">
                    ...
                    <div class="col-xl-3 col-sm-6">
                        <div class="card-box widget-user">
                            <div>
                                <img src="{{asset('assets/images/users/avatar-10.jpg')}}" class="img-fluid rounded-circle avatar-md" alt="user">
                                <div class="wid-u-info">
