...
<head>
    <meta charset="UTF-8">
    <title>{{__('Votre compte a été utilisé sur un nouvel appaereil')}}</title>
</head>
​
<body>
​
                                            ...
                                            <tr
                                                ...
                                                <td
                                                    ...
                                                    <p class="center" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;line-height:1.3;word-break:normal;text-align:center;font-family:'Open Sans', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Geneva, Verdana, sans-serif;font-size:16px;font-weight:400;color:#656565;">
                                                        {{__("Votre compte CinetPay a été utilisé pour vous connecter à l'appareil suivant. Veuillez vérifier les détails ci-dessous pour confirmer qu'il s'agit bien de vous.")}}
                                                    </p>
                                                    <p class="center" style="line-height:1.8;text-align:left;font-family:'Open Sans', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Geneva, Verdana, sans-serif;font-size:16px;font-weight:400;color:#000;background-color: #e8e8e8;padding: 20px;margin-top: 20px;">
                                                        {{__('Date et heure de connexion: ')}} {{$data['connectedAt']}} <br>
                                                        {{__('Pays de connexion: ')}} {{$data['country']}} <br>
                                                        {{__('Ville de connexion: ')}} {{$data['city']}} <br>
                                                        {{__('Appareil: ')}} {{$data['device']}} <br>
                                                        {{__('Address IP: ')}} {{$data['ip']}}
                                                    </p>
                                                    <br>
                                                    <p class="center" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;margin-top:0;margin-bottom:0;margin-right:0;margin-left:0;line-height:1.3;word-break:normal;text-align:center;font-family:'Open Sans', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Geneva, Verdana, sans-serif;font-size:16px;font-weight:400;color:#656565;">
                                                        {{__("Si c'était vous, aucune action n'est requise. Si ce n'était pas vous, suivez le lien pour sécuriser votre compte.")}}
                                                    </p>
                                                </td>
                                                <td class="expander"
